...
function App() {
  ...
  return (
    <Context.Provider value={{ pseudo, setPseudo, newpseudo, setNewPseudo, description, setDesc, newdescription, setNewDesc, pouits, myPouits, addPouit, likePouit, pouitsContest }}>
      <BrowserRouter>
        <Header />
        <Footer/>
        <Switch>
